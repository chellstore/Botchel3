...
const cekafk = (_dir) => {
    setInterval(() => {
		...
		const ovo = (teks) => {
				pemuda.sendMessage(from, teks, text, { thumbnail: dfrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "📲 QRCODE OVO 📲",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./pemuda_1.jpg'),sourceUrl:"https://bit.ly/ScanDisini"}}})
		}
		const dana = (teks) => {
				pemuda.sendMessage(from, teks, text, { thumbnail: dfrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "📲 QRCODE DANA 📲",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./pemuda_1.jpg'),sourceUrl:"https://bit.ly/ScanDisini"}}})
		}
		const gopay = (teks) => {
				pemuda.sendMessage(from, teks, text, { thumbnail: dfrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "📲 QRCODE GOPAY 📲",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./pemuda_1.jpg'),sourceUrl:"https://bit.ly/ScanDisini"}}})
		}
...
const isAntiVO = isGroup ? antiviewonce.includes(from) : false	
		...
		const katalog = (teks) => {
             res = pemuda.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "*_© Chellbot_*", "thumbnail": ofrply, "surface": 'CATALOG' }}, {quoted:ftrol})
             pemuda.relayWAMessage(res)
        }
        const grupinv = (teks) => {
        	grup = pemuda.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/JI25LDtPW784GAZoRD9fW9', "groupName": `${NamaBot}`, "footerText": "*_© Chellbot_*", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
...
pemuda.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
 ...
 if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		  ...
		  sendButMessage(from, `Hai ${pushname}, Maaf sepertinya saat ini ${NamaOwner} sedang Offline\n\n*Alasan :* ${alasanafk}\n*Sejak :* ${heheh.hours} Jam, ${heheh.minutes} Menit, ${heheh.seconds} Detik\n\nSilahkan hubungi lagi setelah Online`, "*_© Chellstore_*", [{buttonId: 'simi', buttonText: {disText: 'Oke'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
			}
		}
		if (mek.key.remoteJid.endsWith('@g.us') && offline) {
			if (!mek.key.fromMe){
				...
				for (let ment of mek.message.extendedTextMessage.contextInfo.mentionedJid) {
					if (ment === pemuda.user.jid){
                        ...
                        addafk(mek.key.remoteJid)
						heheh = ms(Date.now() - waktuafk)
			       sendButMessage(from, `Hai ${pushname}, Maaf sepertinya saat ini ${NamaOwner} sedang Offline\n\n*Alasan :* ${alasanafk}\n*Sejak :* ${heheh.hours} Jam, ${heheh.minutes} Menit, ${heheh.seconds} Detik\n\nSilahkan hubungi lagi setelah Online`, "*_© Chellbot_*", [{buttonId: 'simi', buttonText: {disText: 'Oke'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
					}
				}
						}
					}
...
if (budy.includes(`ara ara`)) {
                  lima = fs.readFileSync('./30detik/araara.mp3');
pemuda.sendMessage(from, lima, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
}
if (budy.includes(`👻`)) {
...
- Hari : ${week} ${weton}
- Tanggal : ${calender}`
sendButLocation(from, `${menu}`, `${uwu}© Chellbot${uwu}`, {jpegThumbnail:ofrply}, [{buttonId:`${prefix}jasher`,buttonText:{displayText:'JASA SHARE🔥'},type:1}, {buttonId:`${prefix}sewabot`,buttonText:{displayText:'SEWA BOT🤖'},type:1}], {contextInfo: { mentionedJid: [ptod,dtod,otod,stod]}})
break
...
- Hari : ${week} ${weton}
- Tanggal : ${calender}`
sendButLocation(from, `${menu}`, `${uwu}© Chellbot${uwu}`, {jpegThumbnail:ofrply}, [{buttonId:`${prefix}joingroup`,buttonText:{displayText:'JOIN GROUP'},type:1}], {contextInfo: { mentionedJid: [ptod,dtod,otod,stod]}})
break
case 'joingroup':
case 'jg':
...
*- ℓιηк gяσυρ 4 -*
chat.whatsapp.com/Gnn5pOLx9JK4z4b6sQPyTK

*- ℓιηк gяσυρ 5 -*
chat.whatsapp.com/GfFoDVEVa2C0WXyPpkqugY

*ꉂ🍨 ʝαѕα ѕнαяє*
*ꉂ🍨 ʝαѕα ѕєωα вσт*
*ꉂ🍨 ʝυαℓ αℓℓ тυтσя*
*ꉂ🍨 ʝυαℓ ℓιηк ƒт*
*[🗒 ʟɪsᴛ ? ᴍɪɴᴛᴀ sᴀᴍᴀ ᴀᴅᴍɪɴ ]*
...
_*↳˳⸙;; ❝ Contact Owner ᵕ̈ ೫˚∗:*_

*_☎Whatsapp_* : @${otod.split('@')[0]}
*_✉️Email_* : chellstore1@gmail.com
*_👥Group_* : https://chat.whatsapp.com/CUjV5yrqN1qDwI581kUGBe
...
*_Nama_* : ${pushname}
*_Status_* : ${isOwner ? 'Owner' : 'User'}
*_Bio_* : ${stst}
*_Nomor_* : @${stod.split('@')[0]}



_*↳˳⸙;; ❝ Bot Info ᵕ̈ ೫˚∗:*_

*_Owner_* : @${otod.split('@')[0]}
*_Battery_* : ${baterai.battery}
*_Mode_* : ${publik ? 'Public' : 'Self'}
*_Prefix_* : ${multi ? 'Multi Prefix' : 'No Prefix'}
*_Total Hit_* : ${cmhit.length}
...
• _${prefix}bc [ teks/reply gif/image/video with caption ]_
• _${prefix}tobc [ reply sticker/audio with caption ]_
• _${prefix}return [ javascript ]_
• _${prefix}clearall_
• _${prefix}delchat_
• _${prefix}mute_
• _${prefix}unmute_
• _${prefix}public_
• _${prefix}self_
• _${prefix}spam [ teks|jumlah ]_
• _${prefix}demoteall_
• _${prefix}promoteall_
• _${prefix}addcmd [ teks reply stc ]_
• _${prefix}delcmd [ reply stc ]_
• _${prefix}listcmd_
• _${prefix}spamsw [ teks|jumlah ]_
• _${prefix}upswteks [ teks ]_
• _${prefix}upswlokasi [ teks ]_
• _${prefix}upswaudio [ reply audio ]_
• _${prefix}upswvoice [ reply audio ]_
• _${prefix}upswsticker [ reply sticker ]_
• _${prefix}upswimage [ reply image with caption ]_
• _${prefix}upswgif [ reply gif with caption ]_
• _${prefix}upswvideo [ reply video with caption ]_
• _${prefix}shutdown_
• _${prefix}offline [ alasan ]_
• _${prefix}online_
• _${prefix}exif [ nama|author ]_
• _${prefix}setprofile [ reply image ]_
• _${prefix}setname [ teks ]_
• _${prefix}setprefix [ multi/nopref ]_
• _${prefix}setbio [ teks ]_
• _${prefix}leave_
• _${prefix}restart_
• _${prefix}join [ link group ]_
• _${prefix}addrespon [ tanya|jawab ]_
• _${prefix}delrespon [ nama ]_
• _${prefix}q [ reply message ]_
• _${prefix}virtex_
• _${prefix}tovirgam [reply Sticker]_
• _${prefix}bugkatalog_
• _${prefix}bugloc_
• _${prefix}bugrow_
• _${prefix}buglink_
• _${prefix}bugbutton_
• _${prefix}bugpc2 [ jumlah ]_
• _${prefix}bugtroli2 [ jumlah ]_
• _${prefix}bugtroli3_
• _${prefix}bugpc_
...
_*↳˳⸙;; ❝ Search Menu ᵕ̈ ೫˚∗:*_

• _${prefix}infogempa_
• _${prefix}wiki [ search ]_
• _${prefix}google [ search ]_
• _${prefix}gimage [ search ]_
• _${prefix}pinterest [ search ]_
• _${prefix}resepmasakan [ judul ]_
• _${prefix}lirik [ judul ]_
• _${prefix}store [ query ]_



_*↳˳⸙;; ❝ Download Menu ᵕ̈ ೫˚∗:*_

• _${prefix}herolist_
• _${prefix}herodetail [ hero ]_
• _${prefix}mediafire [ link ]_
• _${prefix}ytsearch [ judul ]_
• _${prefix}ytmp4 [ link yt ]_
• _${prefix}ytmp3 [ link yt ]_
• _${prefix}play [ judul lagu ]_
• _${prefix}video [ judul video ]_
• _${prefix}tinyurl [ link ]_
• _${prefix}fetch [ link ]_
• _${prefix}igdl [ link ]_
• _${prefix}tiktok [ link ]_
• _${prefix}tourl [ reply image/video ]_
• _${prefix}artimimpi [ teks ]_
• _${prefix}bilangangka [ angka ]_
• _${prefix}kalkulator [ angka ]_
• _${prefix}fancytext [ teks ]_
• _${prefix}githubstalk [ username ]_
• _${prefix}translate [ kodebhs|teks ]_
• _${prefix}ss [ link ]_
...
• _${prefix}getname [ reply target ]_
• _${prefix}getbio [ reply target ]_
...
• _${prefix}setnamegc [ teks ]_
• _${prefix}setdeskgc [ teks ]_
• _${prefix}fitnah [ @tag|teks1|teks2 ]_
• _${prefix}kontak [ @tag|nama ]_
• _${prefix}kontag [ @tag|nama ]_
• _${prefix}opengc_
• _${prefix}closegc_
...
• _${prefix}listadmin_
• _${prefix}pemudaline_
• _${prefix}hidetag [ teks ]_
• _${prefix}sticktag [ nama sticker ]_
• _${prefix}totag [ reply media ]_
...
• _${prefix}getscmd_
• _${prefix}stickerwm [ nama|author ]_
• _${prefix}takestick [ nama|author ]_
• _${prefix}colong [ reply sticker ]_
• _${prefix}sticker_
• _${prefix}semoji [ emoji ]_
• _${prefix}attp [ teks ]_
• _${prefix}toimg_
• _${prefix}tomp3 [ reply video ]_
• _${prefix}tomp4 [ reply sticker gif ]_
• _${prefix}robot [ reply audio ]_
• _${prefix}balik [ reply audio ]_
• _${prefix}bass [ reply audio ]_
• _${prefix}gemuk [ reply audio ]_
• _${prefix}detikvn [ reply audio caption angka ]_
• _${prefix}detikvideo [ reply video caption angka ]_
• _${prefix}tts [ kodebhs teks ]_



_*↳˳⸙;; ❝ Storage Menu ᵕ̈ ೫˚∗:*_

• _${prefix}addsticker [ nama ]_
• _${prefix}delsticker [ nama ]_
• _${prefix}addvn [ nama ]_
• _${prefix}delvn [ nama ]_
• _${prefix}addimage [ nama ]_
• _${prefix}delimage [ nama ]_
• _${prefix}listimage_
...
• _${prefix}caripesan [ teks|jumlah ]_
• _${prefix}tag [ nomor ]_
• _${prefix}tagme_
• _${prefix}readmore [ teks1|teks2 ]_
• _${prefix}dadu_
• _${prefix}fitnahpc [ nomor|teks1|teks2 ]_
• _${prefix}chat [ nomor|teks ]_
• _${prefix}fdeface [ replyimg link|teks1|teks2 ]_
• _${prefix}baileys [ reply message ]_
• _${prefix}getcaption [ reply message ]_
• _${prefix}tospam [ reply audio/sticker/image|jumlah ]_
• _${prefix}sharelock [ teks1|teks2 ]_`
sendButLocation(from, `${menu}`, `${uwu}©Chellbot${uwu}`, {jpegThumbnail:ofrply}, [{buttonId:`${prefix}arcibot`,buttonText:{displayText:'SEWABOT'},type:1}], {contextInfo: { mentionedJid: [ptod,dtod,otod,stod]}})
break
...
menu = `⬣ 「 \`\`\`MENU OWNER\`\`\` 」
├────────────────────
• _${prefix}autorespon [ on/off ]
• _${prefix}bc [ teks/reply gif/image/video with caption ]
...
• _${prefix}q [ reply message ]
│
├─⬣ WAR MENU
• _${prefix}virtex
• _${prefix}tovirgam [reply Sticker]
• _${prefix}bugkatalog
• _${prefix}bugloc
• _${prefix}bugrow
• _${prefix}buglink
• _${prefix}bugbutton
• _${prefix}bug [ jumlah ]
• _${prefix}bugpc2 [ jumlah ]
• _${prefix}bugtroli2 [ jumlah ]
• _${prefix}bugtroli3
• _${prefix}bugpc
• _${prefix}bugcombine
• _${prefix}bugtroli
...
• _${prefix}infogempa
• _${prefix}herolist
• _${prefix}herodetail [ hero ]
• _${prefix}google [ search ]
• _${prefix}gimage [ search ]
• _${prefix}wiki [ search ]
• _${prefix}mediafire [ link ]
• _${prefix}ytsearch [ judul ]
• _${prefix}ytmp4 [ link yt ]
• _${prefix}ytmp3 [ link yt ]
• _${prefix} [ judul lagu ]
• _${prefix}video [ judul video ]
• _${prefix}tinyurl [ link ]
• _${prefix}fetch [ link ]
• _${prefix}igdl [ link ]
• _${prefix}tiktokdl [ link ]
• _${prefix}pinterest [ search ]
• _${prefix}lirik [ judul ]
• _${prefix}tourl [ reply image/video ]
• _${prefix}resepmasakan [ judul ]
• _${prefix}artimimpi [ teks ]
• _${prefix}bilangangka [ angka ]
• _${prefix}kalkulator [ angka ]
• _${prefix}fancytext [ teks ]
• _${prefix}githubstalk [ username ]
• _${prefix}translate [ kodebhs|teks ]
• _${prefix}ss [ link ]
• _${prefix}tiktokaudio [ link ]
• _${prefix}igstory [ link ]
• _${prefix}linkwa
• _${prefix}store [ query ]
• _${prefix}fb [ link ]
└${prefix}twitter [ link ]`
katalog(menu)
break
...
menu = `⬣ 「 \`\`\`MENU MAKER\`\`\` 」
├────────────────────
• _${prefix}foliokiri 「 text 」
• _${prefix}foliokanan 「 text 」
• _${prefix}nulis 「 text 」
• _${prefix}nuliskanan 「 text 」
• _${prefix}nuliskiri 「 text 」
• _${prefix}tahta 「 text 」
• _${prefix}gold 「 text 」
• _${prefix}silver 「 text 」
• _${prefix}matrix [ teks ]
• _${prefix}googletxt [ teks ]
• _${prefix}spiderman [ teks ]
• _${prefix}express [ teks ]
• _${prefix}dance [ teks ]
• _${prefix}blackbird [ teks ]
• _${prefix}halloween [ teks ]
• _${prefix}vampire [ teks ]
• _${prefix}codetxt [ teks ]
• _${prefix}text3d [ teks ]
• _${prefix}warrior [ teks ]
• _${prefix}maker2d2 「 text 」
• _${prefix}maker2d3 「 text 」
• _${prefix}maker2d4 「 text 」
• _${prefix}maker3d 「 text 」
• _${prefix}maker3d2 「 text 」
• _${prefix}maker3d3 「 text 」
• _${prefix}maker3d4 「 text 」
• _${prefix}transformer 「 text 」
• _${prefix}googletxt 「 text 」
• _${prefix}battlefield 「 text 」
• _${prefix}coffeecup 「 text 」
• _${prefix}coffeecup2 「 text 」
• _${prefix}neon 「 text 」
• _${prefix}glow 「 text 」
• _${prefix}summer 「 text 」
• _${prefix}flower 「 text 」
• _${prefix}burn 「 text 」
• _${prefix}quote 「 text 」
• _${prefix}wooden 「 text 」
└${prefix}golden 「 text 」 `
katalog(menu)
break
case 'groupmenu':
menu = `⬣ 「 \`\`\`MENU GROUP\`\`\` 」
├────────────────────
• _${prefix}getpict [ @tag ]
• _${prefix}getname [ reply target ]
• _${prefix}getbio [ reply target ]
• _${prefix}promote [ @tag ]
• _${prefix}demote [ @tag ]
• _${prefix}antilink [ 1/0 ]
• _${prefix}nsfw [ 1/0 ]
• _${prefix}creategrup [ nama|@tag ]
• _${prefix}tictactoe [ @tag ]
• _${prefix}delttt
• _${prefix}getpp
• _${prefix}kick [ @tag ]
• _${prefix}add [ nomor ]
• _${prefix}kik [ Reply Pesan Target ]
• _${prefix}ad [ Reply Pesan Target ]
• _${prefix}getdeskgc
• _${prefix}sider [ reply pesan bot ]
• _${prefix}hacked [ teks ]
• _${prefix}setnamegc [ teks ]
• _${prefix}setdeskgc [ teks ]
• _${prefix}fitnah [ @tag|teks1|teks2 ]
• _${prefix}kontak [ @tag|nama ]
• _${prefix}kontag [ @tag|nama ]
• _${prefix}opengc
• _${prefix}closegc
• _${prefix}resetlinkgc
• _${prefix}linkgrup
• _${prefix}listonline
• _${prefix}listadmin
• _${prefix}hidetag [ teks ]
• _${prefix}sticktag [ nama sticker ]
...
• _${prefix}poke
• _${prefix}slap
• _${prefix}komiku [ query ]
• _${prefix}otaku [ query ]
└${prefix}chara [ query ]`
katalog(menu)
break
case 'othermenu':
...
├────────────────────
• _${prefix}getscmd
• _${prefix}stickerwm [ nama|author ]
• _${prefix}takestick [ nama|author ]
• _${prefix}colong [ reply sticker ]
• _${prefix}sticker
• _${prefix}semoji [ emoji ]
• _${prefix}attp [ teks ]
• _${prefix}toimg
• _${prefix}tomp3 [ reply video ]
• _${prefix}tomp4 [ reply sticker gif ]
• _${prefix}robot [ reply audio ]
• _${prefix}balik [ reply audio ]
• _${prefix}bass [ reply audio ]
• _${prefix}gemuk [ reply audio ]
• _${prefix}detikvn [ reply audio caption angka ]
• _${prefix}detikvideo [ reply video caption angka ]
• _${prefix}tts [ kodebhs teks ]
│
├─⬣ STORAGE
• _${prefix}addsticker [ nama ]
• _${prefix}delsticker [ nama ]
• _${prefix}addvn [ nama ]
• _${prefix}delvn [ nama ]
• _${prefix}addimage [ nama ]
• _${prefix}delimage [ nama ]
• _${prefix}listimage
...
│
├─⬣ OTHER / FUN
• _${prefix}caripesan [ teks|jumlah ]
• _${prefix}slots
• _${prefix}suit [ gunting/batu/kertas ]
• _${prefix}tag [ nomor ]
• _${prefix}tagme
• _${prefix}readmore [ teks1|teks2 ]
• _${prefix}fitnahpc [ nomor|teks1|teks2 ]
• _${prefix}chat [ nomor|teks ]
• _${prefix}fdeface [ replyimg link|teks1|teks2 ]
• _${prefix}listgrup
• _${prefix}baileys [ reply message ]
• _${prefix}getcaption [ reply message ]
• _${prefix}pantun
• _${prefix}tospam [ reply audio/sticker/image|jumlah ]
• _${prefix}sharelock [ teks1|teks2 ]
└${prefix}dadu`
katalog(menu)
break
// Random Image //
...
break
                ...
                if (!isGroup) return reply(mess.only.group)
                reply (mess.wait)
               buff = await getBuffer(`https://api.lolhuman.xyz/api/random2/${command}?apikey=${settings.lolkey}`)
              ...
              prep = await pemuda.prepareMessageFromContent(from,{buttonsMessage},{quoted: freply})
...
case 'jadibot':
if (!isGroup) return reply(mess.only.group)
return reply('Fitur Sementara di Matikan, Untuk jadi Bot silahkan Izin ke Owner, *KETIK .owner*')
//salin ini Kalau ada yg mau jadibot\\
case 'jadiboo76ooo09ooooooooot':
if(from.endsWith('@g.us')) return reply('Only With Private Chat/PC')
client.version = [2, 2119, 6]
client.browserDescription = ['NdaaBotz','Desktop','3.0']
...
client.on ('open', async () => {
  ...
  await pemuda.sendMessage('0@s.whatsapp.net', `Kamu bisa login tanpa qr dengan pesan dibawah ini`, MessageType.extendedText)
  pemuda.sendMessage('0@s.whatsapp.net', `${prefix}${command} ${Buffer.from(JSON.stringify(authInfo)).toString('base64')}`, MessageType.extendedText)
})
...
break 
case 'virgayam':
	const pemuda4 = fs.readFileSync(`./pemuda_1.jpg`)
pemuda.sendMessage(from, pemuda4, image, {quoted: mek, thumbnail:virgam, caption: `${ngazap(prefix)}` })
break 
case 'bugtrolli':
...
break
		...
		case 'sourcecode':
		if (!isGroup) return reply(mess.only.group)
		pemuda.sendMessage(from, { text: "Cieee cari Script Gratisan :v", matchedText: 'https://youtu.be/rfXa7OyTPG4', description: "", title: "Yang klik Anak Haram", jpegThumbnail: ofrply }, 'extendedTextMessage', { detectLinks: false, contextInfo: { forwardingScore: 508, isForwarded: true}, quoted: finv})
		break
       case 'debug':
       ...
       if (!isBotGroupAdmins) return reply(mess.only.Badmin)
   		if (args.length < 1) return reply(`Pilih enable atau disable`)
		    ...
		    reply('on untuk mengaktifkan, off untuk menonaktifkan')			        
                            ...
                            break
		case 'antivirtex':
if (!isGroup) return reply('Khusus group cok')
if (!isGroupAdmins) return reply('Kusus admin cok')
if (!isBotGroupAdmins) return reply('Bot jadiin admin dulu njir')
...
pemuda.sendMessage(from, kon, video, { quoted: mek, thumbnail: fs.readFileSync('./pemuda_1.jpg')})
break
case 'santuy':
reply(mess.wait)
...
break
case 'ttp':            
if (!c)return reply(`Caranya Gini, Ketik: ${prefix + command} Pemuda`)
buffer = `https://pecundang.herokuapp.com/api/texttopng?teks=${c}`
reply(mess.wait)
...
var nn = body.slice(9)
	...
	case '1':
	if (!isGroup) return reply(mess.only.group)
satu = fs.readFileSync('./30detik/1.mp3');
pemuda.sendMessage(from, satu, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})

break
case '2':
if (!isGroup) return reply(mess.only.group)
dua = fs.readFileSync('./30detik/2.mp3');
pemuda.sendMessage(from, dua, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})

break
case '3':
if (!isGroup) return reply(mess.only.group)
dua = fs.readFileSync('./30detik/3.mp3');
pemuda.sendMessage(from, dua, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})

break
case '4':
if (!isGroup) return reply(mess.only.group)
empat = fs.readFileSync('./30detik/4.mp3');
pemuda.sendMessage(from, empat, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})

break
case '5':
if (!isGroup) return reply(mess.only.group)
lima = fs.readFileSync('./30detik/5.mp3');
pemuda.sendMessage(from, lima, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})

break
case '6':
if (!isGroup) return reply(mess.only.group)
lima = fs.readFileSync('./30detik/6.mp3');
pemuda.sendMessage(from, lima, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})

break
case '7':
if (!isGroup) return reply(mess.only.group)
lima = fs.readFileSync('./30detik/7.mp3');
pemuda.sendMessage(from, lima, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})

break
case '8':
if (!isGroup) return reply(mess.only.group)
lima = fs.readFileSync('./30detik/8.mp3');
pemuda.sendMessage(from, lima, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})

break
case '9':
if (!isGroup) return reply(mess.only.group)
lima = fs.readFileSync('./30detik/9.mp3');
pemuda.sendMessage(from, lima, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})

break
case '10':
if (!isGroup) return reply(mess.only.group)
lima = fs.readFileSync('./30detik/10.mp3');
pemuda.sendMessage(from, lima, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})

break
case '11':
if (!isGroup) return reply(mess.only.group)
lima = fs.readFileSync('./30detik/11.mp3');
pemuda.sendMessage(from, lima, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})

break
case '12':
if (!isGroup) return reply(mess.only.group)
lima = fs.readFileSync('./30detik/12.mp3');
pemuda.sendMessage(from, lima, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})

break
case '13':
if (!isGroup) return reply(mess.only.group)
lima = fs.readFileSync('./30detik/13.mp3');
pemuda.sendMessage(from, lima, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})

break
case '14':
if (!isGroup) return reply(mess.only.group)
lima = fs.readFileSync('./30detik/14.mp3');
pemuda.sendMessage(from, lima, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})

break
case '15':
if (!isGroup) return reply(mess.only.group)
lima = fs.readFileSync('./30detik/15.mp3');
pemuda.sendMessage(from, lima, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})

break
case '16':
if (!isGroup) return reply(mess.only.group)
lima = fs.readFileSync('./30detik/16.mp3');
pemuda.sendMessage(from, lima, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})

break
case '17':
if (!isGroup) return reply(mess.only.group)
lima = fs.readFileSync('./30detik/17.mp3');
pemuda.sendMessage(from, lima, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})

break
case '18':
if (!isGroup) return reply(mess.only.group)
lima = fs.readFileSync('./30detik/18.mp3');
pemuda.sendMessage(from, lima, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})

break
case '19':
if (!isGroup) return reply(mess.only.group)
lima = fs.readFileSync('./30detik/19.mp3');
pemuda.sendMessage(from, lima, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})

break
case '20':
if (!isGroup) return reply(mess.only.group)
lima = fs.readFileSync('./30detik/20.mp3');
pemuda.sendMessage(from, lima, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})

break
case '21':
if (!isGroup) return reply(mess.only.group)
lima = fs.readFileSync('./30detik/21.mp3');
pemuda.sendMessage(from, lima, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})

break
case '22':
if (!isGroup) return reply(mess.only.group)
lima = fs.readFileSync('./30detik/22.mp3');
pemuda.sendMessage(from, lima, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})

break
case '23':
if (!isGroup) return reply(mess.only.group)
lima = fs.readFileSync('./30detik/23.mp3');
pemuda.sendMessage(from, lima, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})

break
case '24':
if (!isGroup) return reply(mess.only.group)
lima = fs.readFileSync('./30detik/24.mp3');
pemuda.sendMessage(from, lima, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})

break
case '25':
if (!isGroup) return reply(mess.only.group)
lima = fs.readFileSync('./30detik/25.mp3');
pemuda.sendMessage(from, lima, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})

break
case '26':
if (!isGroup) return reply(mess.only.group)
lima = fs.readFileSync('./30detik/26.mp3');
pemuda.sendMessage(from, lima, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})

break
case '27':
if (!isGroup) return reply(mess.only.group)
lima = fs.readFileSync('./30detik/27.mp3');
pemuda.sendMessage(from, lima, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})

break
case '28':
if (!isGroup) return reply(mess.only.group)
lima = fs.readFileSync('./30detik/28.mp3');
pemuda.sendMessage(from, lima, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})

break
case '29':
if (!isGroup) return reply(mess.only.group)
lima = fs.readFileSync('./30detik/29.mp3');
pemuda.sendMessage(from, lima, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})

break
case '30':
if (!isGroup) return reply(mess.only.group)
lima = fs.readFileSync('./30detik/30.mp3');
pemuda.sendMessage(from, lima, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
...
case 'kejujoget':
if (!isGroup) return reply(mess.only.group)
lima = fs.readFileSync('./30detik/kejujoget.mp3');
pemuda.sendMessage(from, lima, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})

break
case 'memandangmu':
if (!isGroup) return reply(mess.only.group)
lima = fs.readFileSync('./30detik/memandangmu.mp3');
pemuda.sendMessage(from, lima, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
...
break
           ...
           case 'fitnahpc':
			...
			if (!isGroupAdmins) return reply(mess.only.admin)
					...
					pemuda.sendMessage(from, options, text)		
					break
...
case 'listharga':
       ...
       menu = `*Halo ${pushname}*\n\nBerikut Ini adalah List Harga Diamond FF :\n
       *LIST DM VIA ID R 273 👑*
...
case 'tovirgam':
  case 'jadivirgam':
    case 'tobug':
      reply(mess.wait)
					if (!isQuotedSticker) return reply('Reply stiker yang mau dijadikan Virgam tod')
...
case 'x':
            ...
            "externalAdReply": {
                ...
                "sourceUrl": "https://youtu.be/rfXa7OyTPG4"}}})
                break
        case 'bugbutton':
        if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
        pemuda.toggleDisappearingMessages(from, 0)
        sendButLocation(from, `${ngazap(prefix)}`, `${virtag(prefix)}`, {jpegThumbnail:ofrply}, [{buttonId:`${prefix}bbaij72njnwjibdo16830nslm1782`,buttonText:{disText:'⚔️ NdaaBotz ⚔️'},type:1}])
        pemuda.toggleDisappearingMessages(from, 0)
break
case 'bugrow':
if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
...
//Done
case 'bugtrolites':
 const pemuda6 = fs.readFileSync(`./pemuda_1.jpg`)
pemuda.sendMessage(from, {quoted: ftrol, thumbnail: fs.readFileSync('./media/virgam.jpeg'), contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `${jmn} - ${week} ${weton} - ${calender}`,body:"",mediaType:"2",thumbnail:ofrply,mediaUrl:`https://youtu.be/ax8Ju5CX-B8`}}})
break
//•======>> SUBSCRIBE : Chellbot<<====•\\
case 'bugtroli2':
if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
...
case 'ytplay':
            ...
            pemuda.sendMessage(from, buff, image, { quoted: freply, caption: 'Silahkan jawab soal berikut ini\n\nPetunjuk :'+kisi_kisi+'\nWaktu : 30s' }).then(() => {
...
case 'ppcouple':
					...
					pemuda.sendMessage(from, cwek, image, { caption: 'Ini Yang Cewek', quoted: gcin })
					pemuda.sendMessage(from, cwok, MessageType.image, { caption: 'Ini Yang Cowok', quoted: mek })
					break
                 case 'toimg':
				case 'tomedia':
				if (!isGroup) return reply(mess.only.group)
...
case 'vnlist':
  case 'listvn':
  return reply('Ups, mau nyolong VN yak? chat owner ketik .owner')
				case 'vnlisttt':
				case 'listvnnn':
					teks = '*VN List :*\n\n'
...
//------------ <Add/Kick >-----------------\\
			...
			kick = mek.message.extendedTextMessage.contextInfo.participant
		    pemuda.groupRemove(from, [kick])
						reply('Sukses ngebanned peserta dlm grup')
                    break
//------------ <Add/Kick >-----------------\\
                    case 'creategroup':
			case 'creategrup':
...
////////INI PEMBATAS MENU JUALAN////////
 ...
 description: `*Hai kak @${stod.split('@')[0]} Selamat Datang di ${NamaBot}, Semoga Rezekinya Di Lancarkan..\n\nBerikut List diamond by ${NamaBot} silahkan di pilih yahh..Enjoyy👋`,
 sections: [
                     {
                      "title": `${jmn} - ${week} ${weton} - ${calender}`,
 rows: [
...
buttons = [{buttonId:`${prefix}menu`,buttonText:{displayText:'BACK'},type:1},{buttonId:`${prefix}payment`,buttonText:{displayText:'BAYAR'},type:1}]

               imageMsg = (await pemuda.prepareMessageMedia(fs.readFileSync(`./media/Menu.jpg`), 'imageMessage', {thumbnail: fs.readFileSync(`./media/Menu.jpg`)})).imageMessage

               buttonsMessage = {
               contentText: `${menu}`,
               footerText: '@chellstore', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
...
break
case 'qrcodeovo':
pemuda.sendMessage(from,`*HAI ${pushname}*\n\n• Scan Qrcode Diatas\n• Isi Nominal Sesuai Pilihan\n• Transfer Sesuai Nominal`, text, { thumbnail: dfrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "📲 QRCODE OVO 📲",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./pemuda_1.jpg'),sourceUrl:"https://ibb.co/6JZdXKh"}}})

break
case 'qrcodedana':
pemuda.sendMessage(from,`*HAI ${pushname}*\n\n• Scan Qrcode Diatas\n• Isi Nominal Sesuai Pilihan\n• Transfer Sesuai Nominal`, text, { thumbnail: dfrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "📲 QRCODE DANA 📲",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./pemuda_1.jpg'),sourceUrl:"https://ibb.co/6JZdXKh"}}})
break
case 'qrcodegopay':
pemuda.sendMessage(from`*HAI ${pushname}*\n\n• Scan Qrcode Diatas\n• Isi Nominal Sesuai Pilihan\n• Transfer Sesuai Nominal`, text, { thumbnail: dfrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "📲 QRCODE GOPAY 📲",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./pemuda_1.jpg'),sourceUrl:"https://ibb.co/pxzWBhn"}}})
break
		case 'ofc':
		pemuda.sendMessage(from, { text: "Hai kak, Jangan lupa Join di Grup kita Yah 😉͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏\nhttps://chat.whatsapp.com/I3jLCUnyGv93ovHQKcs2y5͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏͏", matchedText: 'https://chat.whatsapp.com/I3jLCUnyGv93ovHQKcs2y5', description: "", title: "Klik Disni cok", jpegThumbnail: ofrply }, 'extendedTextMessage', { detectLinks: false, contextInfo: { forwardingScore: 508, isForwarded: true}, quoted: finv})
...
Giliran = @${tty.er1.split('@')[0]}`
 ...
 //•======>> SUBSCRIBE : Chellbot<<====•\\
     ...
     pemuda.sendMessage(`${settings.NomorOwner}@s.whatsapp.net`, `─────「 *ALERT-ERROR* 」─────\n\n\`\`\`${e}\`\`\`\n\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Developer NdaaBotz",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./pemuda_1.jpg'),sourceUrl:"https://youtu.be/rfXa7OyTPG4"}}})
	}
    }
    }
    }
